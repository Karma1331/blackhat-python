...
# Modify packet destined to remote host
def request_handler(buffer):
    return buffer


# Modify packet destined to local host
...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    # receive, process and send remote buffer
    if receive_first:
    ...
    # loop send/receive from/to local/remote
    while True:
...
def server_loop(local_host, local_port, remote_host, remote_port, receive_first):
    ...
    while True:
        ...
        print(f"[==>] Received incoming connection from {remote_host}:{remote_port}")
